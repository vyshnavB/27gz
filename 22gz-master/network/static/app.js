...
init();
  ...
  // Get the button that opens the modal popup
  var btn = document.getElementById("shareBtn");

  // Get the <span> element that closes the modal popup
  ...
  // When the user clicks the button, open the modal popup
  btn.onclick = function() {
    // Set the value of the URL input to the current page's URL
    urlInput.value = window.location.href;

    modal.style.display = "block";
  }

  // When the user clicks on <span> (x), close the modal popup
  ...
  // When the user clicks the Copy button, copy the URL to the clipboard
  copyBtn.onclick = function() {
    ...
    // Reset the text of the Copy button after 3 seconds
    setTimeout(function() {
